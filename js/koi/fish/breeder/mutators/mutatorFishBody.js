...
MutatorFishBody.prototype.mutate = function(random) {
    this.body.length = this.mutateUint8(this.body.length, this.SAMPLER_LENGTH, random);
    this.body.radius = this.mutateUint8(this.body.radius, this.SAMPLER_RADIUS, random);
